...
ActiveRecord::Schema.define(version: 20_190_120_183_617) do
  ...
  create_table 'forbidden_words', id: :serial, force: :cascade do |t|
    t.string 'word'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end
  ...
  create_table 'voting_sessions', id: :serial, force: :cascade do |t|
    t.string 'ip'
    t.datetime 'created_at', null: false
    t.datetime 'updated_at', null: false
  end
